...
!!! info "`RuneTable_itemList` table"
	...
	```
	??? example
		=== "Rune_ActiveList/RuneSetActiveList"
			```lua
				[14] = {
					{1001364, 1},
					{1001365, 1},
